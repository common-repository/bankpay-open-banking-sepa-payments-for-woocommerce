...
// namespace BankPay\WooCommerce\Buttons\GooblePayButton;
...
class PropertiesDictionary
{
     ...
     * @var string
     */
    public const UPDATE_SHIPPING_CONTACT = 'bankpay_apple_pay_update_shipping_contact';
    /**
     * @var string
     */
    public const UPDATE_SHIPPING_METHOD = 'bankpay_apple_pay_update_shipping_method';
    /**
     * @var string
     */
    public const VALIDATION = 'bankpay_apple_pay_validation';
    /**
     * @var string
     */
    public const CREATE_ORDER = 'bankpay_apple_pay_create_order';
    /**
     * @var string
     */
    public const CREATE_ORDER_CART = 'bankpay_apple_pay_create_order_cart';
    /**
     * @var string
     */
    public const REDIRECT = 'bankpay_apple_pay_redirect';
}
